  ...
  [
    {
      ...
      "queryString": "WITH last_education AS (SELECT a.user_id, array_agg(a.degree)[1] AS degree, array_agg(a.year_to)[1] AS year_to FROM dev_level_3_database.cv_partner_education a INNER JOIN (SELECT user_id, max(year_to) AS year_to FROM dev_level_3_database.cv_partner_education GROUP BY user_id) b ON a.user_id = b.user_id AND a.year_to = b.year_to GROUP BY  a.user_id) SELECT emp.user_id, emp.guid, navn,ad.manager, title, link, degree, emp.email, image_key, cv_no_pdf, cv_int_pdf, cv_no_docx, cv_int_docx, ubw_cost.customer, ubw_cost.weigth as weight, ubw_cost.work_order_description FROM dev_level_3_database.cv_partner_employees AS emp LEFT OUTER JOIN last_education AS e ON e.user_id = emp.user_id LEFT OUTER JOIN dev_level_3_database.ubw_customer_per_resource as ubw_cost ON emp.guid=ubw_cost.guid LEFT OUTER JOIN dev_level_3_database.active_directory as ad ON ad.guid=emp.guid order by navn",
      "tables": [
        "active_directory",
      ...
      "lastUsed": null,
      "lastCacheUpdate": "2021-08-19T13:55:03.630411"
    },
    {
      "name": "competence",
      "queryString": "WITH last_education AS (SELECT a.user_id, array_agg(a.degree)[1] AS degree, array_agg(a.year_to)[1] AS year_to FROM dev_level_3_database.cv_partner_education a INNER JOIN (SELECT user_id, max(year_to) AS year_to FROM dev_level_3_database.cv_partner_education GROUP BY  user_id ) b ON a.user_id = b.user_id AND a.year_to = b.year_to GROUP BY  a.user_id) SELECT emp.user_id, navn, title, link, degree, email, image_key, cv_no_pdf, cv_int_pdf, cv_no_docx, cv_int_docx FROM dev_level_3_database.cv_partner_employees AS emp LEFT OUTER JOIN last_education AS e ON e.user_id = emp.user_id order by navn",
      "tables": [
        "cv_partner_education",
        "cv_partner_employees"
      ],
    ...
    },
    {
      ...
      "lastUsed": null,
      "lastCacheUpdate": "2021-08-19T10:13:57.609442"
    },
    {
      "name": "ageDistribution",
      "queryString": "select age, count(age) as count from (SELECT year(now()) - born_year as age FROM dev_level_3_database.dev_level_3_database.cv_partner_employees where born_year > 0) where age > 10 group by age order by age asc",
      "tables": [
        "cv_partner_employees"
      ],
      "dataProtection": 3,
    ...
    {
      "name": "fagActivity",
      "queryString": "SELECT substr(reg_period, 1, 4) as year, substr(reg_period, 5, 6) as week, used_hrs FROM dev_level_2_database.ubw_fagtimer order by year, week asc",
      "tables": [
        "ubw_fagtimer"
      ],
      "dataProtection": 3,
    ...
    {
      "name": "employeeImages",
      "queryString": "select * from dev_level_3_database.cv_partner_employee_images",
      "tables": [],
      "dataProtection": 3,
    ...
    {
      "name": "newCategories",
      "queryString": "SELECT DISTINCT c.text AS category, CAST(ARRAY_AGG(DISTINCT q.topic) AS JSON) AS subCategories FROM dev_level_3_database.kompetansekartlegging_questions AS q INNER JOIN dev_level_3_database.kompetansekartlegging_categories AS c ON q.categoryid = c.id GROUP BY c.text",
      "tables": [
        "kompetansekartlegging_categories",
        "kompetansekartlegging_questions"
      ],
      ...
      "lastUsed": null,
      "lastCacheUpdate": "2021-08-19T10:13:59.202904"
    },
    {
      "name": "projectStatus",
      "queryString": "select user_id, navn, title, email from dev_level_3_database.cv_partner_employees",
      "tables": [
        "cv_partner_employees"
      ],
      "dataProtection": 3,
    ...
    {
      "name": "categories",
      "queryString": "select * from dev_level_3_database.kompetansekartlegging_categories",
      "tables": [
        "kompetansekartlegging_categories"
      ],
      "dataProtection": 3,
      ...
      "lastUsed": null,
      "lastCacheUpdate": "2021-08-19T10:14:00.424136"
    },
    {
      "name": "workExperience",
      "queryString": "SELECT ex.user_id, emp.email, employer, month_from, year_from, month_to, year_to FROM dev_level_3_database.cv_partner_work_experience ex LEFT outer JOIN dev_level_3_database.cv_partner_employees emp on ex.user_id = emp.user_id",
      "tables": [
        "cv_partner_employees",
    ...
    },
    {
      ...
      "lastUsed": null,
      "lastCacheUpdate": "2021-08-19T10:14:02.012215"
    },
    {
      "name": "yearsSinceSchoolDist",
      "queryString": "SELECT year(now()) - career_start AS years, count(career_start) AS count FROM (SELECT user_id, max(year_to) AS career_start FROM dev_level_3_database.cv_partner_education GROUP BY  user_id) GROUP BY  career_start ORDER BY  count desc",
      "tables": [
        "cv_partner_education"
      ],
      "dataProtection": 3,
    ...
    },
    {
      ...
      "queryString": "SELECT emp.user_id, navn, customer, description, year_from, year_to, month_from,  month_to FROM dev_level_3_database.cv_partner_project_experience AS exp JOIN (SELECT user_id, navn FROM dev_level_3_database.cv_partner_employees) emp ON exp.user_id = emp.user_id",
      "tables": [
        "cv_partner_employees",
        "cv_partner_project_experience"
      ],
    ...
    },
    {
      ...
      "lastUsed": null,
      "lastCacheUpdate": "2021-08-19T10:14:03.776379"
    },
    {
      "name": "perProject",
      ...
      "lastUsed": null,
      "lastCacheUpdate": "2021-08-23T11:59:55.360492"
    },
    {
      ...
      "lastUsed": null,
      "lastCacheUpdate": "2021-08-19T10:14:05.848203"
    }
  ]
  ]