...
import {NavMenu, NavMenuItem} from './NavMenu'; // component to test
import { BrowserRouter } from 'react-router-dom';


describe("NavMenuItem", () =>{
    it("renders link with correct label to correct href", () =>{
        render(<BrowserRouter><NavMenuItem label = "testLabel" to = "testLink"/></BrowserRouter>)
...
describe("NavMenu",() =>{
    ...
    render(<BrowserRouter><NavMenu>{FakeNavMenuItem}</NavMenu></BrowserRouter>)
