...
type PercentAreaChartsData = { [chartLabel: string]: number | string } & { x: number | string}
...
const getPercent = (value: number, total: number) => toPercent(total > 0 ? value / total : 0, 2)

const renderTooltipContent = ({ payload, label } : { payload: any[], label: string }) => {
